from examples.arithmetic.baselines.naive.ff_nsl.data import load_nn_data
...
if __name__ == '__main__':
    ...
    parser.add_argument('--task_type', default='sum')
    ...
    if args.tune:
        ...
        for r in range(NUM_NAIVE_BASELINE_REPEATS):
            ...
            torch.save(net.state_dict(), join('networks', f'{args.pct}_{r+1}.pt'))
